  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://formsubmit.co/ajax/mostakin4556@gmail.com",
        {
          method: "POST",
          headers: {
    ...
    <section id="contact" className="py-24 md:px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="space-y-8 md:w-2/3 md:pl-10">
            ...
            <div className="pt-8 mb-10 md:ml-15">
              ...
              <div className="flex space-x-4 justify-center">
                ...
                <a href="https://x.com/MostakinAhmed71" target="_blank">
                  <Twitter />
                </a>
                <a
                  href="https://www.instagram.com/mostakinahmed"
                  target="_blank"
                >
                  <Instagram />
                </a>
          ...
          <div className="bg-card md:p-8 p-4 rounded-lg shadow-xs">
            <h3 className="md:text-2xl text-xl font-semibold mb-6">Send a Message</h3>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary"
                  placeholder="mostakin@gmail.com"
                />
              </div>
